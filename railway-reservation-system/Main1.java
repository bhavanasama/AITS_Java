...
public class Main1 {
    ...
    public static class ReservationSystem {
        ...
        public void displayTrainInformation(String source, String destination) {
            ...
            System.out.println("Train\tSource\tDestination\tDeparture Time\tSeats\tTrain Number");
        ...
        public boolean bookTicket(String passengerName, int seatNumber, int trainNumber) {
            try {
                ...
                if (selectedTrain.bookSeat()) {
                    ...
                    System.out.println("Ticket booked successfully for passenger " + passengerName+" Seat number " +seatNumber+" and train number "+trainNumber);
                    return true;
                } else {
